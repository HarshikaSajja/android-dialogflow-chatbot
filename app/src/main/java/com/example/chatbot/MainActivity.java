...
import com.example.chatbot.adapter.RecyclerViewAdapter;
import com.example.chatbot.model.CommunicatorBot;
import com.example.chatbot.model.MessageMutator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeBot() {
        final AIConfiguration configuration = new AIConfiguration("2eefe104a4c747d5afc9c4838f699897",
    ...
    private void setBaseView() {
        ...
        MessageMutator messageMutator = new MessageMutator();
        messageMutator.setMessage("Hi! How can i help you?");
        messageList.add(messageMutator);
